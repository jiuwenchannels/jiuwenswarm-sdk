...
Quick start::
    ...
    from openjiuwen.sdk.agents.swarm import SwarmFlow
...
class SwarmFlow:
    ...
    * ``"first"``         — pick the first non-empty response.
    ...
    def create(
        ...
        Args:
            agents:   List of :class:`~openjiuwen.sdk.core.agent.Agent` instances.
    ...
    async def run(
        ...
        *,
        ...
        Raises:
            :class:`~openjiuwen.sdk.core.errors.SdkError`: If all agents fail.
        """
