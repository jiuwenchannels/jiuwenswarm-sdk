...
subsequent :meth:`~openjiuwen.sdk.agent.Agent.run` and
:meth:`~openjiuwen.sdk.agent.Agent.stream` calls with OpenTelemetry spans.
...
class OtelTracer:
    ...
    def instrument(self, agent: Any) -> None:
        ...
        Args:
            agent: A :class:`~openjiuwen.sdk.agent.Agent` instance.
        """
        if not self._active:
            log.warning(
