...
class Attachment:
    ...
    def from_file(cls, path: str | Path) -> "Attachment":
        ...
        Raises:
            :class:`~openjiuwen.sdk.errors.SdkError`: If the MIME type is not supported.
        """
        p = Path(path)
...
class ImageInput:
    ...
    def from_file(cls, path: str | Path) -> "ImageInput":
        ...
        Raises:
            :class:`~openjiuwen.sdk.errors.SdkError`: If the MIME type is not a supported image type.
        """
        p = Path(path)
        mime, _ = mimetypes.guess_type(str(p))
        if mime is None:
...
class AudioInput:
    ...
    def from_file(cls, path: str | Path) -> "AudioInput":
        ...
        Raises:
            :class:`~openjiuwen.sdk.errors.SdkError`: If the MIME type is not a supported audio type.
        """
        p = Path(path)
        mime, _ = mimetypes.guess_type(str(p))
        if mime is None:
...
class MultimodalAgent:
    ...
    Note:
        ...
        :class:`~openjiuwen.sdk.agent.Agent` with multimodal configuration.
    ...
    async def create(
        ...
        *,
        ...
        Args:
            name:          Agent name.
            model:         :class:`~openjiuwen.sdk.config.ModelConfig` (default from env).
    ...
    async def run(
        ...
        *,
        ...
        Returns:
            :class:`~openjiuwen.sdk.agent.AgentResult`.
        """
