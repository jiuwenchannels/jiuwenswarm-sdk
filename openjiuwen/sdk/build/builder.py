...
Quick start::
    ...
    from openjiuwen.sdk.build.builder import LlmAgentBuilder, PromptBuilder
...
class AgentBuilder:
    """Generic fluent builder for :class:`~openjiuwen.sdk.core.agent.Agent` instances.
...
class LlmAgentBuilder:
    ...
    def tool(self, tool_name_or_obj: "str | SdkTool") -> "LlmAgentBuilder":
        """Register a tool by name or :class:`~openjiuwen.sdk.core.tools.SdkTool` object."""
    ...
    def with_model_config(self, model_cfg: "ModelConfig") -> "LlmAgentBuilder":
        """Set a full :class:`~openjiuwen.sdk.core.config.ModelConfig` (overrides :meth:`model`)."""
