...
class Workspace:
    ...
    escapes *root* via ``..`` traversal raises :class:`~openjiuwen.sdk.errors.SdkError`.
    ...
    def _safe_path(self, relative: str | Path) -> Path:
        ...
        Raises:
            :class:`~openjiuwen.sdk.errors.SdkError`: If the resolved path is outside *root*.
        """
    ...
    async def read(self, path: str | Path) -> str:
        ...
        Raises:
            :class:`~openjiuwen.sdk.errors.SdkError`: If the path is outside root.
        """
    ...
    async def run_command(
        ...
        *,
        ...
        Raises:
            :class:`~openjiuwen.sdk.errors.SdkError`: If the command fails or times out.
        """
        if self._sandbox:
