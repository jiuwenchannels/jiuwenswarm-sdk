...
``Hooks`` is a convenience wrapper around :class:`~openjiuwen.sdk.core.events.EventEmitter`.
...
@dataclass
class Hooks:
    """Collection of lifecycle callbacks for an :class:`~openjiuwen.sdk.core.agent.Agent`.
    ...
    :class:`~openjiuwen.sdk.core.agent.Agent`.
    """
    ...
    def wire(self, emitter: Any) -> None:
        ...
        The *emitter* is an :class:`~openjiuwen.sdk.core.events.EventEmitter`.
        Called internally by :class:`~openjiuwen.sdk.core.agent.Agent` after
        construction.
        """
