"""Tests for openjiuwen.sdk.a2a — RemoteAgent client facade."""
...
from openjiuwen.sdk.a2a import A2AError, A2AResult, RemoteAgent, _extract_text
from openjiuwen.sdk.errors import ConnectionError, StreamError
...
def mock_a2a(request):
    ...
    with patch("openjiuwen.sdk.a2a._create_a2a_client", return_value=fake_client):
...
class TestRemoteAgentRun:
    ...
    async def test_run_raises_connection_error_when_no_extension(self):
        with patch("openjiuwen.sdk.a2a._create_a2a_client", side_effect=ImportError("no a2a")):
            agent = RemoteAgent("http://host:9000", "svc")
